package jdbc.task2.service.impl;

import jdbc.task2.dao.MovieDAO;
import jdbc.task2.dao.impl.MovieDAOImpl;
import jdbc.task2.entity.MovieEntity;
import jdbc.task2.service.MovieService;
import jdbc.task2.service.base.BaseMovie;

import java.sql.SQLException;
import java.util.List;
import java.util.Optional;

/* Service sends data to DAO */
/* Gets protected data from Parent Class -> BaseMovie */
/* Implements behavior contract from MovieService */
